...
for line in f:
 try:
  temp = line.split(': ')[1];
  temp0 = line.split(': ')[0];
  if('Media' not in temp and name in temp0): # If any form of media is sent, WhatsApp prints "<Media Omitted>". Getting rid of this. TO DO: Improve this functionality. 
   arr.append(temp)
 except:
     print " "
f.close()
